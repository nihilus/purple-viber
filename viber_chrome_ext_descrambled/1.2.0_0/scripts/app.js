    ...
    2: [function(e, t, n) {
        ! function(e, n) {
            ...
            function b(e) {
                var t = G,
                    n = Re[e];
                return n || (n = x(e, t), "none" !== n && n || (_e = (_e || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = _e[0].contentDocument, t.write(), t.close(), n = x(e, t), _e.detach()), Re[e] = n), n
            }

            function w(e, t, n) {
                var r, i, o, a, s = e.style;
                return n = n || $e(e), n && (a = n.getPropertyValue(t) || n[t]), n && ("" !== a || Z.contains(e.ownerDocument, e) || (a = Z.style(e, t)), We.test(a) && Be.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
            }
            ...
            function N(e, t) {
                for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++) r = e[a], r.style && (o[a] = ve.get(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && ke(r) && (o[a] = ve.access(r, "olddisplay", b(r.nodeName)))) : (i = ke(r), "none" === n && i || ve.set(r, "olddisplay", i ? n : Z.css(r, "display"))));
            ...
            function L(e, t, n) {
                ...
                if (Z.isEmptyObject(p)) "inline" === ("none" === c ? b(e.nodeName) : c) && (d.display = c);
                    ...
                    for (r in p) a = O(h ? g[r] : 0, r, f), r in g || (g[r] = a.start, h && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
                }
            }
            ...
            function M(e, t, n) {
                var r, i, o = 0,
                    ...
                    u = function() {
                        if (i) return !1;
                        for (var t = Ke || S(), n = Math.max(0, c.startTime + c.duration - t), r = n / c.duration || 0, o = 1 - r, a = 0, u = c.tweens.length; u > a; a++) c.tweens[a].run(o);
                ...
                return Z.map(l, O, c), Z.isFunction(c.opts.start) && c.opts.start.call(e, c), Z.fx.timer(Z.extend(u, {
                    elem: e,
                    anim: c,
                    queue: c.opts.queue
            ...
            var ie = function(e) {
                function t(e, t, n, r) {
                    ...
                    if ((t ? t.ownerDocument || t : R) !== L && O(t), t = t || L, n = n || [], s = t.nodeType, "string" != typeof e || !e || 1 !== s && 9 !== s && 11 !== s) return n;
                    if (!r && M) {
                        if (11 !== s && (i = ye.exec(e)))
                            if (a = i[1]) {
                                if (9 === s) {
                            ...
                            if (d = f = _, h = t, g = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                ...
                function d(e, t, n) {
                    ...
                    return t.first ? function(t, n, o) {
                        ...
                        if (a) {
                            ...
                            for (; t = t[r];)
                                if (1 === t.nodeType || i) {
                                    if (u = t[_] || (t[_] = {}), (s = u[r]) && s[0] === B && s[1] === o) return c[2] = s[2];
                ...
                function v(e, t, n, i, o, a) {
                    return i && !i[_] && (i = v(i)), o && !o[_] && (o = v(o, a)), r(function(r, a, s, u) {
                        var c, l, f, p = [],
                            ...
                            x = n ? o || (r ? e : h || i) ? [] : a : y;
                        if (n && n(y, x, s, u), i)
                            for (c = m(x, d), i(c, [], s, u), l = c.length; l--;)(f = c[l]) && (x[d[l]] = !(y[d[l]] = f));
                        if (r) {
                            if (o || e) {
                                if (o) {
                        ...
                        } else x = m(x === a ? x.splice(h, x.length) : x), o ? o(null, a, x, u) : J.apply(a, x)
                    })
                }
                ...
                function y(e) {
                    for (var t, n, r, i = e.length, o = T.relative[e[0].type], a = o || T.relative[" "], s = o ? 1 : 0, u = d(function(e) {
                        ...
                        if (n = T.relative[e[s].type]) l = [d(h(l), n)];
                            ...
                            if (n = T.filter[e[s].type].apply(null, e[s].matches), n[_]) {
                    ...
                    var i = n.length > 0,
                        ...
                        a = function(r, a, s, u, c) {
                            var l, f, p, d = 0,
                                ...
                                w = x.length;
                            for (c && (A = a !== L && a); h !== w && null != (l = x[h]); h++) {
                                if (o && l) {
                                    for (f = 0; p = e[f++];)
                                        if (p(l, a, s)) {
                                            u.push(l);
                ...
                var b, w, T, k, C, j, E, N, A, S, D, O, L, q, M, I, F, H, P, _ = "sizzle" + 1 * new Date,
                    R = e.document,
                    B = 0,
                    W = 0,
                    $ = n(),
                ...
                w = t.support = {}, C = t.isXML = function(e) {
                    ...
                    return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, q = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", ke, !1) : n.attachEvent && n.attachEvent("onunload", ke)), M = !C(r), w.attributes = i(function(e) {
                    ...
                    }, F = [], I = [], (w.qsa = ve.test(r.querySelectorAll)) && (i(function(e) {
                    ...
                    })), (w.matchesSelector = ve.test(H = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && i(function(e) {
                        w.disconnectedMatch = H.call(e, "div"), H.call(e, "[s!='']:x"), F.push("!=", ae)
                    }), I = I.length && new RegExp(I.join("|")), F = F.length && new RegExp(F.join("|")), t = ve.test(q.compareDocumentPosition), P = t || ve.test(q.contains) ? function(e, t) {
                        ...
                        return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === R && P(R, e) ? -1 : t === r || t.ownerDocument === R && P(R, t) ? 1 : S ? ee(S, e) - ee(S, t) : 0 : 4 & n ? -1 : 1)
                    } : function(e, t) {
                        if (e === t) return D = !0, 0;
                        var n, i = 0,
                            o = e.parentNode,
                    ...
                    if ((e.ownerDocument || e) !== L && O(e), n = n.replace(fe, "='$1']"), !(!w.matchesSelector || !M || F && F.test(n) || I && I.test(n))) try {
                        var r = H.call(e, n);
                        if (r || w.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r
                    } catch (i) {}
                    return t(n, L, null, [e]).length > 0
                }, t.contains = function(e, t) {
                    return (e.ownerDocument || e) !== L && O(e), P(e, t)
                }, t.attr = function(e, t) {
                            ...
                            return 1 === r && 0 === i ? function(e) {
                                ...
                                if (m) {
                                    ...
                                    if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                        for (l = m[_] || (m[_] = {}), c = l[e] || [], d = c[0] === B && c[1], p = c[0] === B && c[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();)
                                            if (1 === f.nodeType && ++p && f === t) {
                                                l[e] = [B, d, p];
                                                break
                                            }
                                    } else if (y && (c = (t[_] || (t[_] = {}))[e]) && c[0] === B) p = c[1];
                                    else
                                        for (;
                                            (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++p || (y && ((f[_] || (f[_] = {}))[e] = [B, p]), f !== t)););
                ...
                return f.prototype = T.filters = T.pseudos, T.setFilters = new f, j = t.tokenize = function(e, n) {
                    ...
                    var n, r = [],
                        ...
                        o = z[e + " "];
                    if (!o) {
                        for (t || (t = j(e)), n = t.length; n--;) o = y(t[n]), o[_] ? r.push(o) : i.push(o);
                ...
                }, w.sortStable = _.split("").sort(X).join("") === _, w.detectDuplicates = !!D, O(), w.sortDetached = i(function(e) {
            ...
            Z.event = {
                ...
                trigger: function(t, n, r, i) {
                    ...
                    if (a = s = r = r || G, 3 !== r.nodeType && 8 !== r.nodeType && !Ae.test(d + Z.event.triggered) && (d.indexOf(".") >= 0 && (h = d.split("."), d = h.shift(), h.sort()), c = d.indexOf(":") < 0 && "on" + d, t = t[Z.expando] ? t : new Z.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : Z.makeArray(n, [t]), f = Z.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                        ...
                        for (o = 0;
                            (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, l = (ve.get(a, "events") || {})[t.type] && ve.get(a, "handle"), l && l.apply(a, n), l = c && a[c], l && l.apply && Z.acceptData(a) && (t.result = l.apply(a, n), t.result === !1 && t.preventDefault());
            ...
            Pe.optgroup = Pe.option, Pe.tbody = Pe.tfoot = Pe.colgroup = Pe.caption = Pe.thead, Pe.th = Pe.td, Z.extend({
                ...
                buildFragment: function(e, t, n, r) {
                    for (var i, o, a, s, u, c, l = t.createDocumentFragment(), f = [], p = 0, d = e.length; d > p; p++)
                        ...
                        for (o = o || l.appendChild(t.createElement("div")), a = (Oe.exec(i) || ["", ""])[1].toLowerCase(), s = Pe[a] || Pe._default, o.innerHTML = s[1] + i.replace(De, "<$1></$2>") + s[2], c = s[0]; c--;) o = o.lastChild;
                ...
                domManip: function(e, t) {
                    ...
                    var n, r, i, o, a, s, u = 0,
                        ...
                        p = e[0],
                        g = Z.isFunction(p);
                    if (g || c > 1 && "string" == typeof p && !K.checkClone && Me.test(p)) return this.each(function(n) {
                        var r = l.eq(n);
                    ...
                    if (c && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                        ...
                        if (o)
                            for (s = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++) a = i[u], Ie.test(a.type || "") && !ve.access(a, "globalEval") && Z.contains(s, a) && (a.src ? Z._evalUrl && Z._evalUrl(a.src) : Z.globalEval(a.textContent.replace(He, "")))
                    }
                    return this
                }
            }), Z.each({
            ...
            Z.extend({
                ...
                style: function(e, t, n, r) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var i, o, a, s = Z.camelCase(t),
                            u = e.style;
                        return t = Z.cssProps[s] || (Z.cssProps[s] = k(u, s)), a = Z.cssHooks[t] || Z.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Xe.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || Z.cssNumber[s] || (n += "px"), K.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u[t] = n)), void 0)
                    }
                },
                css: function(e, t, n, r) {
                    var i, o, a, s = Z.camelCase(t);
                    return t = Z.cssProps[s] || (Z.cssProps[s] = k(e.style, s)), a = Z.cssHooks[t] || Z.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = w(e, t, r)), "normal" === i && t in Ve && (i = Ve[t]), "" === n || n ? (o = parseFloat(i), n === !0 || Z.isNumeric(o) ? o || 0 : i) : i
                }
                ...
                Z.cssHooks[t] = {
                    ...
                    set: function(e, n, r) {
                        var i = r && $e(e);
                        return C(e, n, r ? j(e, t, r, "border-box" === Z.css(e, "boxSizing", !1, i), i) : 0)
                    }
                }
                ...
                }, Be.test(e) || (Z.cssHooks[e + t].set = C)
            }), Z.fn.extend({
                css: function(e, t) {
            ...
            Z.fn.extend({
                ...
                toggleClass: function(e, t) {
                    ...
                    return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(Z.isFunction(e) ? function(n) {
                        ...
                        else(n === je || "boolean" === n) && (this.className && ve.set(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : ve.get(this, "__className__") || "")
                    })
                },
                hasClass: function(e) {
            ...
            Z.extend({
                ...
                ajax: function(e, t) {
                    ...
                    if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || wt) + "").replace(ft, "").replace(mt, Tt[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(de) || [""], null == f.crossDomain && (u = vt.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === Tt[1] && u[2] === Tt[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (Tt[3] || ("http:" === Tt[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), F(yt, f, t, w), 2 === x) return w;
            ...
            }), K.cors = !!Ot && "withCredentials" in Ot, K.ajax = Ot = !!Ot, Z.ajaxTransport(function(e) {
                var t;
            ...
            Z.ajaxSetup({
                ...
                var i, o, a, s = t.jsonp !== !1 && (qt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && qt.test(t.data) && "data");
                return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(qt, "$1" + i) : t.jsonp !== !1 && (t.url += (lt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
                    return a || Z.error(i + " was not called"), a[0]
                }, t.dataTypes[0] = "json", o = e[i], e[i] = function() {
                    a = arguments
                }, r.always(function() {
                    e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Lt.push(i)), a && Z.isFunction(o) && o(a[0]), a = o = void 0
                }), "script") : void 0
            ...
            Z.offset = {
                ...
                offset: function(e) {
                    ...
                    var t, n, r = this[0],
                        ...
                        o = r && r.ownerDocument;
                    if (o) return t = o.documentElement, Z.contains(t, r) ? (typeof r.getBoundingClientRect !== je && (i = r.getBoundingClientRect()), n = B(o), {
            ...
            return Z.noConflict = function(t) {
                return e.$ === Z && (e.$ = Ht), t && e.jQuery === Z && (e.jQuery = Ft), Z
        ...
        (function() {
            ...
            function o(e, t) {
                var n = q.length,
                    ...
                    o = "constructor";
                for (b.has(e, o) && !b.contains(t, o) && t.push(o); n--;) o = q[n], o in e && e[o] !== i[o] && !b.contains(t, o) && t.push(o)
            }
            var a = this,
                s = a._,
                u = Array.prototype,
            ...
            b.bind = function(e, t) {
                ...
                var n = function(r) {
                    ...
                    return b.has(i, o) || (i[o] = e.apply(this, arguments)),
                        i[o]
                };
                return n.cache = {}, n
            ...
            b.escape = H(I), b.unescape = H(F), b.result = function(e, t, n) {
...
": "u2029"
    ...
    4: [function(e, t, n) {
        ...
        var r = e("underscore"),
            i = e("jquery");
        window.jQuery = i, e("jquery.easing");
        var o, a, s = e("./modules/background_bridge.js"),
            u = e("./modules/utils.js"),
            c = e("./modules/page_helper.js"),
            l = e("./modules/analytics.js"),
            f = e("./config/config.production.js"),
            p = i("body"),
            d = window.location.toString(),
            h = r.some(f.DISALLOWED_URLS, function(e) {
                return d.indexOf(e) > -1
            });
        h || chrome.storage.sync.get(null, function(e) {
            e.hideImageButton || v(), e.hideTextButton || x()
        }), chrome.runtime.onMessage.addListener(function(e, t, n) {
            "action-clicked" === e.event ? m(e.data) : "context-clicked" === e.event ? g(e.data) : "popup-button-clicked" === e.event ? w() : "client-timeout" === e.event ? b() : "open-client" === e.action && window.location.assign("viber://forward")
        });
        var g = function(e) {
                if (e.mediaType && "image" === e.mediaType) {
                    var t = i("<img/>").attr("src", e.srcUrl);
                    if (!u.isApplicableImage(t)) return;
                    s.sendImage(e.srcUrl), l.trackEvent({
                        action: "right click image clicked"
                    })
                } else e.linkUrl ? c.retrievePageInfo(e.linkUrl).then(function(e) {
                    s.sendData(e)
                }, function() {
                    s.sendURL({
                        url: e.linkUrl,
                        title: e.selectionText
                    })
                }) : e.selectionText ? (y(e.selectionText), l.trackEvent({
                    action: "right click selection clicked"
                })) : c.retrievePageInfo().then(function(e) {
                    s.sendData(e), l.trackEvent({
                        action: "right click page clicked"
                    })
                })
            },
            m = function(e) {
            ...
            v = function() {
                var e, t = "span.viber-share",
                    n = i("<span></span>"),
                    o = 0;
                u.isAppInstalled("gpdjojdkbbmdfjfahjcgigfpmkopogic").done(function(e) {
                    e && setTimeout(function() {
                        var e = i("body > span").filter(function() {
                            return "8675309" === i(this).css("z-index")
                        });
                        0 !== e.length && (o = 30)
                    }, 1500)
                }), n.css({
                    ...
                    display: "none",
                    "z-index": 2147483646,
                    "background-image": 'url("' + chrome.extension.getURL("images/button@2x.png") + '")',
                    cursor: "pointer",
                    "background-repeat": "no-repeat"
                }).addClass("viber-share").attr("id", r.uniqueId("viber")), p.append(n), p.delegate("img", "mouseenter", function() {
                    if (e = i(this), (e.height() >= 100 && e.width() >= 200 || e.height() >= 200 && e.width() >= 100) && u.isApplicableImage(e)) {
                        var t = e.offset();
                        n.css({
                            display: "block",
                            top: t.top + 10 + o,
                ...
                }), p.delegate("img", "mouseout", function(t) {
                    n.attr("id") !== i(t.relatedTarget).attr("id") && (n.hide(), e = null)
                }), p.delegate(t, "click", function() {
                    var t = document.createElement("a");
                    t.href = e.attr("src");
                    var r = t.href;
                    s.sendImage(r, e.attr("alt")), l.trackEvent({
                        action: "image icon clicked"
                    }), n.hide()
                })
            },
            y = function(e) {
                c.retrievePageInfo().then(function(t) {
                    t.description = '"' + e.toString().trim() + '"', s.sendData(t)
                })
            },
            x = function() {
                var e = i("<span></span>"),
                ...
                e.css({
                    ...
                    display: "none",
                    "z-index": 2147483647,
                    "background-image": 'url("' + chrome.extension.getURL("images/text-button@2x.png") + '")',
                    cursor: "pointer",
                    "background-repeat": "no-repeat"
                }).addClass("viber-share-selection").attr("id", r.uniqueId("viber")), p.prepend(e), e.on("mouseup", function() {
                    y(a), l.trackEvent({
                        action: "icon quote clicked"
                    }), e.hide()
                }), i(document).on("mouseup", function(n) {
                    setTimeout(function() {
                        var r = i(n.target);
                        if (!r.is("input") && !r.is("textarea")) {
                            var o, s = window.getSelection().toString().trim();
                            try {
                                o = window.getSelection().getRangeAt(0).getBoundingClientRect()
                            } catch (u) {
                                return
                            }
                            if (s.length < 1e3 && s.length >= 12) {
                                t -= n.clientY;
                                var c;
                                c = t >= 0 ? o.top - 21 + document.body.scrollTop - 2 : o.bottom + document.body.scrollTop - 2, e.css({
                                    top: c,
                                    left: n.clientX - 11 + document.body.scrollLeft
                                }).show(0), a = window.getSelection().toString()
                            }
                        }
                    }, 5)
                }), i(document).on("mousedown", function(n) {
                    t = n.clientY, n.target !== e.get(0) && e.hide()
                })
            },
            b = function() {
                o || (o = i("<iframe></iframe>"), o.css({
                    border: "none",
                    position: "fixed",
                    right: -3,
                    top: -23,
                    ...
                    width: "432px",
                    height: "500px"
                }), i(document).one("click", function() {
                    w()
                }), o.attr("src", chrome.runtime.getURL("popup.html")), o.load(function() {
                    o.animate({
                        opacity: .96,
                        top: -3
                    }, 180)
        ...
        "./config/config.production.js": 5,
        "./modules/analytics.js": 6,
        "./modules/background_bridge.js": 7,
        "./modules/page_helper.js": 8,
        "./modules/utils.js": 9,
        jquery: 2,
        "jquery.easing": 1,
        underscore: 3
        ...
        var r = e("jquery"),
            ...
            o = function(e) {
                ...
                return n.then(function(n) {
                    var r = /^(https?\:\/\/)?(www\.)?(youtube\.com|youtu\.be)\/.+$/,
                        i = /^(https?\:\/\/)?(www\.)?(vimeo\.com)\/.+$/,
                        o = {},
                        a = s("og:url", n);
                    r.test(e), r.test(u("url", "href", n)) ? (o.type = "video", o.site = "youtube", o.url = u("url", "href", n), o.title = u("name", "content", n), o.thumbURL = u("thumbnailUrl", "href", n)) : i.test(e) && i.test(a) ? (o.type = "video", o.site = "vimeo", o.url = a, o.title = n.title, o.thumbURL = s("twitter:image", n)) : (o.type = "other", o.url = e, o.title = n.title), t.resolve(o)
                }, function() {
                    t.reject()
                }), t
            },
            a = function(e) {
                var t = r.Deferred();
                return e === window.location.href ? t.resolve(document) : r.ajax(e).then(function(n) {
                    var r = document.implementation.createHTMLDocument(e);
                    r.open(), r.write(n), r.close(), t.resolve(r)
                }, function() {
                    t.reject()
                }), t
            },
            s = function(e, t) {
                t = t ? t : document;
                for (var n = t.getElementsByTagName("meta"), r = 0; r < n.length; r++)
                    if (n[r].getAttribute("property") === e || n[r].getAttribute("name") === e) return n[r].getAttribute("content");
                return ""
            },
            u = function(e, t, n) {
                n = n || document, t = t || "content";
                var o = r("[itemprop]", n),
                    a = i.find(o, function(t) {
                        return r(t).attr("itemprop") === e
                    });
                return r(a).attr(t) || ""
            };
        t.exports = {
