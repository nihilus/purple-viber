! function e(t, n, r) {
    ...
    1: [function(e, t, n) {
        ! function(e, n) {
            ...
            var ie = function(e) {
                ...
                var b, w, T, C, N, k, E, S, D, j, A, q, L, H, O, F, M, P, R, W = "sizzle" + 1 * new Date,
                    $ = e.document,
                    I = 0,
                    B = 0,
                    _ = n(),
                ...
                w = t.support = {}, N = t.isXML = function(e) {
                    ...
                    return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = r.documentElement, n = r.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), O = !N(r), w.attributes = i(function(e) {
                    ...
                    }, M = [], F = [], (w.qsa = ve.test(r.querySelectorAll)) && (i(function(e) {
                        ...
                        w.disconnectedMatch = P.call(e, "div"), P.call(e, "[s!='']:x"), M.push("!=", se)
                    ...
                    if ((e.ownerDocument || e) !== L && q(e), n = n.replace(fe, "='$1']"), !(!w.matchesSelector || !O || M && M.test(n) || F && F.test(n))) try {
                        var r = P.call(e, n);
            ...
            Re.optgroup = Re.option, Re.tbody = Re.tfoot = Re.colgroup = Re.caption = Re.thead, Re.th = Re.td, Z.extend({
                ...
                buildFragment: function(e, t, n, r) {
                    for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; d > p; p++)
                        ...
                        for (o = o || c.appendChild(t.createElement("div")), s = (qe.exec(i) || ["", ""])[1].toLowerCase(), a = Re[s] || Re._default, o.innerHTML = a[1] + i.replace(Ae, "<$1></$2>") + a[2], l = a[0]; l--;) o = o.lastChild;
                ...
                html: function(e) {
                    return me(this, function(e) {
                        ...
                        if ("string" == typeof e && !He.test(e) && !Re[(qe.exec(e) || ["", ""])[1].toLowerCase()]) {
                            e = e.replace(Ae, "<$1></$2>");
                            try {
                ...
                domManip: function(e, t) {
                    ...
                    if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                        ...
                        if (o)
                            for (a = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++) s = i[u], Fe.test(s.type || "") && !ve.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Pe, "")))
                    }
                    return this
                }
            }), Z.each({
            ...
            Z.extend({
                ...
                ajax: function(e, t) {
                    ...
                    if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || wt) + "").replace(ft, "").replace(mt, Tt[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(de) || [""], null == f.crossDomain && (u = vt.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === Tt[1] && u[2] === Tt[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (Tt[3] || ("http:" === Tt[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), M(yt, f, t, w), 2 === x) return w;
    ...
    2: [function(e, t, n) {
        ...
        r(document).ready(function() {
            r("body").addClass(navigator.userAgent.indexOf("Mac OS X") > -1 ? "mac" : "pc"), i(), document.getElementById("download").addEventListener("click", function() {
                chrome.runtime.sendMessage({
                    event: "popup-button-clicked"
                }), window.open("http://www.viber.com/en/products/windows", "_blank")
            })
        });
        var i = function() {
